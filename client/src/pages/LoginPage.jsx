  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      flex-col gap-6 rounded-lg shadow-lg' action="">
        ...
        <button type='submit' disabled={loading} className='py-3 bg-gradient-to-r from-purple-400
         to-violet-600 text-white rounded-md cursor-pointer disabled:opacity-50'>
